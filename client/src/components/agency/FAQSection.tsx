...
const faqData: FAQItem[] = [
  {
    ...
    answer: "Вартість залежить від обраного пакету та платформи. Meta Ads від $300/міс, Google Ads від $350/міс, TikTok Ads від $400/міс. Розробка сайтів від $800, мобільних додатків від $3000. Ми пропонуємо гнучкі тарифи: Basic, Standard та Premium. Точну вартість розраховуємо індивідуально після аналізу вашого бізнесу."
  },
  {
