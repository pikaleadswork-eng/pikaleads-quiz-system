    ...
    <>
      ...
      <div className="min-h-screen bg-black text-white">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                ...
                <div className="flex flex-wrap gap-4">
                  <Button size="lg" className="bg-[#00F0FF] text-black hover:bg-[#00F0FF]/90 font-bold" onClick={() => document.getElementById('calc-form')?.scrollIntoView({ behavior: 'smooth' })}>
                    Отримати прорахунок дизайну <ArrowRight className="ml-2 w-5 h-5" />
                  </Button>
              ...
              <div className="relative flex items-center justify-center">
                ...
                <div className="relative z-10 w-full aspect-square max-w-md mx-auto">
                  <img src="/web-design-hero.png" alt="Web Design" className="w-full h-full object-contain drop-shadow-2xl" />
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-zinc-900/50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-12">
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-5xl font-black text-white mb-6">Вам це знайомо, коли мова заходить про дизайн?</h2>
            </div>
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-10">
              {[
                { title: "Дизайн є, але він не допомагає", desc: "Сайт виглядає ніби нормально, але люди не залишають заявки — і незрозуміло чому." },
                { title: "Все виглядає складно і перевантажено", desc: "Багато елементів, кольорів, блоків — але немає відчуття, що це працює на результат." },
                { title: "Дизайн не відповідає продукту", desc: "Він або занадто простий, або занадто \"креативний\", але не відображає суть бізнесу." },
                { title: "Страх витратити гроші дарма", desc: "Бо дизайн уже робили, а заявок так і не з'явилось." }
              ].map((problem, i) => (
        ...
        <section className="py-16 bg-black">
          <div className="container mx-auto px-4 sm:px-6 lg:px-12">
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-5xl font-black text-white mb-6">Як ми робимо дизайн, який допомагає продавати</h2>
              <p className="text-xl text-zinc-400 max-w-3xl mx-auto">Без зайвих елементів і складних рішень.</p>
            </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-12">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-10">
                <h2 className="text-4xl md:text-5xl font-black text-white mb-6">Отримайте прорахунок дизайну під ваш бізнес</h2>
        ...
        <section className="py-16 bg-black">
          <div className="container mx-auto px-4 sm:px-6 lg:px-12">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-zinc-400 max-w-3xl mx-auto">Без зайвих елементів — тільки те, що реально впливає на заявки.</p>
            </div>
        ...
        <section className="py-16 bg-zinc-900/50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-12">
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-5xl font-black text-white mb-6">Що зазвичай змінюється після нового дизайну</h2>
            </div>
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-10">
              {[
        ...
        <section className="py-16 bg-gradient-to-br from-zinc-900 via-black to-zinc-900">
          <div className="container mx-auto px-4 sm:px-6 lg:px-12">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-10">
                <h2 className="text-4xl md:text-5xl font-black text-white mb-6">Хочете дизайн, який допомагає продавати?</h2>
