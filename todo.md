...
## Phase 155: Генерація Пікачу та оновлення сторінки квізів (CURRENT)
- [ ] Згенерувати 3-4 варіанти кібер-панк Пікачу з окулярами на білому фоні
- [ ] Додати адресу в футер: Рівненська обл., м.Рівне., вул. Млинівська 12
- [ ] Виправити кнопки квізів на сторінці /quizzes (квізи не відкриваються)
- [ ] Синхронізувати шрифти (Bungee для заголовків як на головній)
- [ ] Поміняти текст на "Квіз системи для вашого бізнесу, що працюють на результат"
- [ ] Додати поп-ап до кнопки "Почати зараз"
- [ ] Видалити кнопку "Дивитись відео"

## Phase 155 Status Update:
- [x] Згенерувати 3-4 варіанти кібер-панк Пікачу з окулярами на білому фоні
- [x] Додати адресу в футер: Рівненська обл., м.Рівне., вул. Млинівська 12
- [x] Виправити кнопки квізів на сторінці /quizzes (квізи не відкриваються)
- [x] Синхронізувати шрифти (Bungee для заголовків як на головній)
- [x] Поміняти текст на "Квіз системи для вашого бізнесу, що працюють на результат"
- [x] Додати поп-ап до кнопки "Почати зараз"
- [x] Видалити кнопку "Дивитись відео"

## Phase 156: Застосувати шрифт Bungee до заголовка на /quizzes
- [ ] Знайти заголовок "Квіз системи для вашого бізнесу" на сторінці /quizzes
- [ ] Застосувати шрифт Bungee (як на головній "ОБИРАЙ НЕ АГЕНСТВО")
- [x] Перевірити візуально на сайті

## Phase 157: Видалити lead magnet блок зі сторінки квізів
- [x] Знайти блок "ВІДЧУВАЄТЕ ЩО ВАША РЕКЛАМА ПРАЦЮЄ СЛАБО?" в Home.tsx
- [x] Видалити весь блок з таймером та формою
- [x] Залишити тільки FAQ секцію
- [x] Перевірити візуально

## Phase 158: Додати Пікачу та змінити шрифт на сторінці квізів
- [x] Скопіювати нову картинку Пікачу (безфона-2.png) в client/public/pikachu-quiz-hero.png
